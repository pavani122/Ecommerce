...
<body>
<c:set var="i" scope="session" value="${name }" />
<c:if test="${i==null }">
<div class="navigation" style="display: flex;justify-content: space-between;">
<div  style="display: flex;flex-direction: row;gap: 30px;">
<div>
<a href="/Ecommerce/main"><img alt="pharmeasy-logo"
 src="https://assets.pharmeasy.in/apothecary/images/logo_big.svg?dim=360x0"></a>
</div>
...
<ul style="  list-style-type: none;display: flex;flex-direction:row;gap:20px;">
<li><a href="/Ecommerce/register" style="text-decoration: none;font-size: 20px">Register</a></li>
<li><a href="/Ecommerce/login" style="text-decoration: none;font-size: 20px">Login</a></li>
<li><img src="https://assets.pharmeasy.in/web-assets/dist/21b0b5ba.svg" alt="cartImg"></li>
<li><a href="/Ecommerce/cart" style="text-decoration: none;font-size: 20px">cart</a></li>
</ul>
</div>
</div>
</c:if>
