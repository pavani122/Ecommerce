...
<h1>Register</h1>
   ...
   <hr>
<div id="errors"><b><form:errors path="name"></form:errors></b></div>
<label id="fields"><b>Name</b></label>
<form:input path="name"/>

<div id="errors"><b><form:errors path="email"></form:errors><br></b></div>
<label id="fields"><b>Email</b></label>
<form:input path="email"/>

<div id="errors"><b><form:errors path="password"></form:errors><br></b></div>
<label id="fields"><b>Password</b></label><form:password path="password"/>

<div id="errors"><b><form:errors path="number"></form:errors><br></b></div>
<label id="fields"><b>Mobile Number</b></label><form:input path="number"/>

<div id="errors"><b><form:errors path="gender"></form:errors><br></b></div>
